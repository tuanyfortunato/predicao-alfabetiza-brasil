...
def _fontes():
    ...
    return {
        ...
        "censo2022_municipio": pd.DataFrame({"id_municipio": ids, "populacao": [20000, 80000], "domicilios": [7000, 30000],
                                             "area": [4000, 8000], "taxa_alfabetizacao_adultos": [0.90, 0.95],
        ...
        "censo_escolar_municipio": pd.DataFrame({"ano": [2022, 2022, 2023, 2023], "id_municipio": ids * 2, "n_escolas_ai": [10, 30, 11, 31],
